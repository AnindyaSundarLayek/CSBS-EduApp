...
function Navbar() {
  ...
  return (
    <>
      ...
      ?"sticky-navbar shadow-md bg-base-200 dark: bg-slate-200 dark:text-white duration-300 transition-all ease-in-out":""
    }`}>
        <div className="navbar ">
          <div className="navbar-start">
            <div className="dropdown ">
              <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden hover:bg-pink-500 duration-200">
                <svg
            ...
            <img src={csbs2} alt='logo' className=' h-9 object-contain' />
